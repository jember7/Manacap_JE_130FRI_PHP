...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            <a href="/contact.php" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</a>
             <a href="ourmission.php" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Our Mission</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <p>Hello you are in Our Mission Page</p>
    </div>
  </main>
</div>
